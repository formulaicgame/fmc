use tiny_skia::{Pixmap, Transform, PixmapPaint, PremultipliedColorU8};

const SIZE: i32 = 16;

fn main() {
    let top = Pixmap::load_png("top.png").unwrap();
    let mut left_side = Pixmap::load_png("side.png").unwrap();
